...
while(cont):
    ...
    if (com == 'exit'):
        ...
        if(com == 'read' and tab == 'groups'):
            ...
            if (validator.checkStr(name) and validator.checkNum(year) and validator.checkNum(num_of_exc) and validator.checkNum(teacher)):
                groups.create(name, year, num_of_exc, teacher)
        elif(com == 'create' and tab == 'teachers'):
            name = view.getName()
            surname = view.getSurname()
            if (validator.checkStr(name) and validator.checkStr(surname)):
                teachers.create(name, surname)
        elif(com == 'create' and tab == 'classes'):
            name = view.getName()
            teacher = view.getTeacher()
            if (validator.checkStr(name) and validator.checkNum(teacher)):
                classes.create(name, teacher)
